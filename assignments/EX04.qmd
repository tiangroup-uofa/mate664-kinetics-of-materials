...
![Cross section of heterogeneous nucleus formed on a conical pit in
 the wall of a material.](./img/EX4-pit-1.svg){width="35%" #fig-pit-1}

![Growth of nucleus in and out of the pit. The positions of the meniscus for 3 different stages are marked](./img/EX4-pit-2.svg){width="35%" #fig-pit-2}
...
$g^{\text{homo}}$. Please take a look at the online demo [https://tiangroup-uofa.github.io/mate664-kinetics-of-materials/scripts/EX04_cahn_hilliard.html](https://tiangroup-uofa.github.io/mate664-kinetics-of-materials/scripts/EX04_cahn_hilliard.html). When
tuning the parameters $\omega$, $\kappa$, $x_{B0}$, identify one example for each of the following
behaviors, if observed:
...
:::{.callout-note}
You do not need to explore the full parameter space systematically.
Finding one representative example for each observed behavior is
sufficient.
:::
...
The simulated regimes will be very close to those seen in Lecture 20. However you can realize the implementation of a real solution free energy term in Cahn-Hilliard is more difficult.
