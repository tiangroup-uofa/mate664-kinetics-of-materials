...
calculated. We provide an online demo []() to demonstrate the change
...
a) Instead of the double well potential in Lecture 20, we can
...
where $\omega$ is a parameter measuring the degree of mixing energy between A and B.
What is the equation for $g^{\text{homo}}(x_B)$ in this case?
...
c) Simulating the Cahn-Hilliard equation with regular solution free energy
