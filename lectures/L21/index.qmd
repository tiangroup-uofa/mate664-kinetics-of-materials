...
[Buffon's need problem](https://en.wikipedia.org/wiki/Buffon%27s_needle_problem) is one of the earliest demonstration to estimate an unknown quantity (here $\pi$) via sampling. The probability of a needle with length $l$ intersecting parallel lines spaced at $d$ is:
...
## Buffon's need problem: visualization

- How fast do the MC sampling converge?
- Can such integation be distributed over different systems?
...
only caring about the probabilitites a vacancy exchanges with a
...
in the cannonical (NVT) ensemble of system, such distribution follow
...
![Comput. Mater. Sci._ 135, 78–89 (2017).](./public/admat-kmc.pmg)


## KMC example 2: deposition on graphene
...
![](../L10/public/ncomm-kmc2.png)

## Deposition on Graphene - KMC vs Experiments


![](../L10/public/ncomm-kmc-exp.png)
