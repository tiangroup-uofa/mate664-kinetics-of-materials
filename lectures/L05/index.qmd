...
- **Recall** the different types of diffusivities in solids
- **Describe** the basic mechanisms in interdiffusion systems
- **Analyze** the driving forces for various diffusion mechanisms
- **Analyze** changes of reference frame in diffusion experiments
