...
- Identify the driving force when a system become supercooled or supersaturated
- Understand the difference between discontinuous (nucleation) and continuous (spinodal decomposition) phase transformations
- Analyze the free energy barrier $\Delta G_c$ during nucleation
- Describe in your own words the emergence of surface / interfacial energy
- Describe in your own words the kinetic model for particle size evolution in pseudo-steady-state nucleation
