...
- PDF version of course note  👉 [Open in pdf](./L03.pdf)
- Handwritten notes 👉 [Open in pdf](./public/L03-notes_annotated.pdf)
:::
...
- **Recall** the entropy production equation and its rate form
- **Analyze** the entropy production expression in terms of driving forces
- **Derive** the general equation for driving forces in a system
- **Describe** the reciprocal relation between coupled transport processes
